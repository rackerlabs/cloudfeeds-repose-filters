...
public class TenantFilterTest {
    ...
    static final String tidBad = "66666";
    ...
    @Test
    public void entriesUri200WrongTid() throws Exception {

        TenantFilter tf = new TenantFilter();

        String content = getEntry( tidBad, "" );
    ...
    public void entriesUri200CodeValidXml() throws Exception {
        ...
        String content = getEntry( tidGood, "" );
    ...
    @Test
    public void entriesUri200CodePrivateEvent() throws Exception {

        TenantFilter tf = new TenantFilter();

        String content = getEntry( tidGood, "<atom:category term=\"cloudfeeds:private\" />" );
    ...
    private String getEntry( String tid, String extraCats ) {
        return "<atom:entry>" +
              "<atom:id>urn:uuid:c36318b8-5d03-6985-d379-fc5a9df6f4b0</atom:id>" +
              "<atom:category term=\"tid:" + tid + "\" />" +
              ...
              "resourceName=\"Mosso Standard Offering\" tenantId=\"" + tid + "\" type=\"USAGE_SNAPSHOT\" version=\"1\">" +
